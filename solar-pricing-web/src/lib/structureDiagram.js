// صفحة التصميم بالـPDF: تضمّن صورة الرندر 3D الحقيقي (من structure3d.js) بهوية الشركة
...
export function buildStructurePageHtml(panelCount, company = {}, imgDataUrl = '', capability = null, integrated = null) {
  ...
  const feats = integrated
    ...
    : [
        ['🔧', 'تركيب احترافي', 'فريق فني متخصص وتنفيذ دقيق حسب المواصفات'],
        ['🛡️', 'مواد أصلية معتمدة', 'ماركات عالمية بضمان — أداء يدوم لعشرات السنين'],
        ['🕐', 'صيانة ودعم 24/7', 'خدمة صيانة ومتابعة متوفرة على مدار الساعة'],
      ];
...
<div class="mkt-sheet">
  ...
  <div class="hero">
    ...
    <p>${integrated
      ...
      : 'تصميم وتوزيع ألواح بأعلى المعايير — أداء يدوم لعشرات السنين'}</p>
  </div>
  <div class="stage"><img src="${imgDataUrl}" alt="${integrated ? 'الكابينة المتكاملة' : 'مخطط توزيع الألواح'}"/></div>
