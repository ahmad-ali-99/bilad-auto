...
5) دستور التسعير (الهندسة القيمية — المعتمد رسمياً):
   ...
   • standard: أقل عدد أجهزة ممكن (وحدة وحدة إذا تتحمل — تركيب أبسط ونقاط عطل أقل)، وبين المتساوية بالعدد السعر الوسط. استثناء: من 100 أمبير فما فوق يوزع الحمل على ~3 انفيرترات للاستمرارية (Redundancy) وتخفيف الضغط الحراري.
   • premium: نفس قاعدة أقل عدد أجهزة، وبين المتساوية بالعدد الأغلى (الأرقى مواصفات) — بدون تفضيل ماركة معينة.
