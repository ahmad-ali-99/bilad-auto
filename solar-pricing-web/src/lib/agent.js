...
5) دستور التسعير (الهندسة أولاً ثم السعر — المعتمد رسمياً):
   • الهندسة ثابتة بكل المستويات: أقل عدد بطاريات وانفيرترات يغطي الأمبيرية.
   • economy: الأرخص ضمن مجموعة أقل عدد وحدات — أقل سعر نهائي بهندسة صحيحة.
   • standard: الوسط سعراً ضمن نفس المجموعة.
   • premium: منظومة مرتاحة حتى لو زاد الحمل — الانفيرتر موزع على وحدتين بهامش ≥30% (كل جهاز محمل ≤~70% مع Redundancy)، والبطاريات الأرقى ضمن أقل عدد + وحدة بطارية إضافية احتياط.
   • عدد الألواح دائماً زوجي (التركيب أزواج على 2 MPPT) — إذا الحساب طلع فردي ينضاف لوح مكمل.
   • بدون تفضيل ماركة معينة بأي مستوى.
