...
5) المستويات والأسعار:
   • economy = أرخص توليفة تغطي الحاجة (حتى لو عدد بطاريات أكثر — قرار الشركة: المهم السعر إذا التشغيل صحيح)، standard = الأوسط سعراً، premium = الأغلى. البياع يكدر يبدل أي مادة يدوياً.
