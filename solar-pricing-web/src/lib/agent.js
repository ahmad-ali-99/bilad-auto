...
5) دستور التسعير (الهندسة أولاً، الـIP قبل السعر — المعتمد رسمياً):
   • الهندسة ثابتة بكل المستويات: أقل عدد بطاريات وانفيرترات يغطي الأمبيرية بدقة، والسعر ثانوي يجي بعد الـIP.
   • ماكو معامل أمان للبطاريات — أُلغي. معامل الأمان الوحيد هو عمق التفريغ (DoD) من الإعدادات: عدد البطاريات = حاجة الليل ÷ DoD ÷ سعة البطارية، تقريباً للأعلى. المستويات تتفرق بالمواصفة (درجة الحماية) مو بكمية الطاقة.
   • economy: أقل عدد وحدات ← أدنى فئة IP متوفرة بالحجم (غير المذكور IP يُعد IP21) ← الأرخص داخل الفئة.
   • standard: أقل عدد وحدات ← أعلى حماية IP للانفيرتر (مثل IP65 كوز باور قبل IP21) ← الأرخص عند تساوي الـIP. بطارية المتوسط: الوسط سعراً ضمن أقل عدد.
   • premium ≤120 أمبير: هويمايلز حصراً — قدرة الانفيرترات الكلية ≥ الطلب ×1.3 بتكبير حجم الجهاز بأقل عدد وحدات (بلا توزيع إجباري على وحدتين)، والبطارية الأكبر سعة ضمن أقل عدد (بلا وحدة احتياط إضافية) — التعديد يصير طبيعياً بالأحجام الكبيرة فقط.
   • premium فوق 120 أمبير: نفس القاعدة لكن بكل الماركات (هويمايلز ما تغطي الأحجام الكبيرة).
   • عدد الألواح حر (يُسمح بالفردي) — العدد = ألواح التغذية + ألواح الشحن بلا تدوير، والبياع يزيد أو ينقص لوحاً واحداً بكل نقرة.
