...
5) دستور التسعير (الهندسة أولاً، الـIP قبل السعر — المعتمد رسمياً):
   ...
   • premium ≤120 أمبير: هويمايلز حصراً — انفيرتر هويمايلز موزع على وحدتين بهامش ≥30% (كل جهاز ≤~70% مع Redundancy) + بطارية هويمايلز الأرقى ضمن أقل عدد + وحدة إضافية احتياط.
   • premium فوق 120 أمبير: نفس قواعد الراحة لكن بكل الماركات (هويمايلز ما تغطي الأحجام الكبيرة).
