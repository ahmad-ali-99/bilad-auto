...
5) دستور التسعير (الهندسة أولاً، الـIP قبل السعر — المعتمد رسمياً):
   ...
   • معاملات أمان البطاريات (من الإعدادات، افتراضياً: اقتصادي 0.90، متوسط 0.85، ممتاز 0.80): حاجة الليل تنضرب بالمعامل قبل حساب عدد البطاريات — حتى بطارية 16kWh وحدة تغطي حاجة حدية بدل ما ننجبر على ثنتين.
